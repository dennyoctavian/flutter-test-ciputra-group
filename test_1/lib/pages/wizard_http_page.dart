...
class WizardHttpPage extends StatefulWidget {
  const WizardHttpPage({super.key});

  @override
  State<WizardHttpPage> createState() => _WizardHttpPageState();
}

class _WizardHttpPageState extends State<WizardHttpPage> {
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => WizardBloc()..add(GetAllWizardByHttp()),
      child: Scaffold(
        appBar: AppBar(
          title: Text(
            "All Wizards",
